...
public class PassengerInfoAdmin extends JFrame implements ActionListener {
    ...
    public PassengerInfoAdmin(Connect connection) {
        ...
        setTitle(pad + "PASSENGER INFORMATION");
        ...
        headLabel = new JLabel("PASSENGER INFORMATION");
        headLabel.setFont(new Font("TIMES NEW ROMAN", Font.BOLD, 30));
        headLabel.setForeground(Color.WHITE);
        headLabel.setBounds(180, 10, 600, 30);
        p1.add(headLabel);
